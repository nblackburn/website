        ...
        <div :class="styles.content">
            <div :class="styles.meta">
                <ol :class="styles.tags" aria-label="Tags">
                    <li v-for="tag in project.data.tags" :class="[
                        styles.tag,
                        activeTag === slugify(tag) ? styles.activeTag : ''
                    ]" :key="tag">
                        <Link :href="'/projects/tags/' + slugify(tag)" :class="styles.link"
                            :aria-current="activeTag === slugify(tag)">{{ tag }}</Link>
                    </li>
                </ol>
            ...
            <div :class="styles.details">
                ...
                <NavLink :href="project.data.url" :class="styles.projectLink" aria-label="View project (External link)">
                    <svg width="18" height="18" role="img" :class="styles.externalIcon">
                        <use :href="'#external'" />
                    </svg>
